...
zz.template.ui.menu.default = function(opt_data, opt_ignored) {
  return '<button id="demo-menu-lower-left" class="' + goog.getCssName('mdl-button') + ' ' + goog.getCssName('mdl-js-button') + ' ' + goog.getCssName('mdl-button--icon') + '"><i class="' + goog.getCssName('material-icons') + '">more_vert</i></button><ul id="1" class="' + goog.getCssName('mdl-menu') + ' ' + goog.getCssName('mdl-menu--bottom-left') + ' ' + goog.getCssName('mdl-js-menu') + ' ' + goog.getCssName('mdl-js-ripple-effect') + '" for="demo-menu-lower-left"><li class="' + goog.getCssName('mdl-menu__item') + '">Some Action</li><li class="' + goog.getCssName('mdl-menu__item') + '">Another Action</li><li disabled class="' + goog.getCssName('mdl-menu__item') + '">Disabled Action</li><li class="' + goog.getCssName('mdl-menu__item') + '">Yet Another Action</li><button id="demo-menu-lower-left" class="' + goog.getCssName('mdl-button') + ' ' + goog.getCssName('mdl-js-button') + ' ' + goog.getCssName('mdl-js-ripple-effect') + '">Some action in button</button></ul>';
};
if (goog.DEBUG) {
