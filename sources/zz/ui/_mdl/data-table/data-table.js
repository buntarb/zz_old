 ...
 * Provide section                                                                                                    *
 **********************************************************************************************************************/
goog.provide( 'zz.ui.mdl.MaterialDataTable' );
...
(function() {
      ...
      return function() {
        ...
        if (checkbox.checked) {
          for (i = 0; i < opt_rows.length; i++) {
            el = opt_rows[i].querySelector('td').querySelector( '.' + goog.getCssName( 'mdl-checkbox' ) );
  ...
  MaterialDataTable.prototype.createCheckbox_ = function(row, opt_rows) {
    ...
    var labelClasses = [
      goog.getCssName( 'mdl-checkbox' ),
      goog.getCssName( 'mdl-js-checkbox' ),
      goog.getCssName( 'mdl-js-ripple-effect' ),
      this.CssClasses_.SELECT_ELEMENT
    ];
    label.className = labelClasses.join(' ');
    var checkbox = document.createElement('input');
    checkbox.type = 'checkbox';
    checkbox.classList.add( goog.getCssName( 'mdl-checkbox__input' ) );
   ...
   * Definition section                                                                                               *
   ********************************************************************************************************************/
  zz.ui.mdl.MaterialDataTable = MaterialDataTable;
