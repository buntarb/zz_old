...
/**
 * @fileoverview Provide zz.ui.Ripple class.
 ...
 * @constructor
 */
zz.ui.Ripple = function( opt_domHelper ){

	goog.ui.Component.call( this, opt_domHelper );
};
goog.inherits( zz.ui.Ripple, goog.ui.Component );
goog.tagUnsealableClass( zz.ui.Ripple );
 ...
 * @override
 */
zz.ui.Ripple.prototype.createDom = function( ){
...
zz.ui.Ripple.prototype.decorateInternal = function( element ){
	 ...
	 * @private
	 */
	this.centeringFlag_ = goog.dom.classlist.contains( this.getElement( ), zz.ui.Ripple.CSS.RIPPLE_CENTER );
	 ...
	 * @private
	 */
	this.rippleElement_ = goog.dom.getElementByClass( zz.ui.Ripple.CSS.RIPPLE, this.getElement( ) );
 ...
 * @inheritDoc
 **/
zz.ui.Ripple.prototype.disposeInternal = function( ){
 ...
 */
zz.ui.Ripple.prototype.animationFrameHandler = function( ){
 ...
 * @private
 */
zz.ui.Ripple.prototype.upHandler_ = function( event ){

	// Don't fire for the artificial "mouseup" generated by a double-click.
	if( event && event.getBrowserEvent( ).detail !== 2 ){

		//noinspection JSValidateTypes
		goog.dom.classlist.remove( this.rippleElement_, zz.ui.Ripple.CSS.IS_VISIBLE );
	}
 ...
 * @private
 */
zz.ui.Ripple.prototype.mdlDowngrade = function( ){
 ...
 * @override
 */
zz.ui.Ripple.prototype.getCssClass = function( ){

	return zz.ui.Ripple.CSS_CLASS;
};
 ...
 */
zz.ui.Ripple.prototype.setRippleStyles = function( start ){
	...
	if( this.rippleElement_ !== null ){
		...
		if( start ){
			...
			scale = zz.ui.Ripple.CONST.INITIAL_SCALE;

		}else{

			scale = zz.ui.Ripple.CONST.FINAL_SCALE;
		...
		if( start ){
			...
			goog.dom.classlist.remove( /** @type {Element} */( this.rippleElement_ ), zz.ui.Ripple.CSS.IS_ANIMATING );

		}else{

			this.rippleElement_.classList.add(zz.ui.Ripple.CSS.IS_ANIMATING);
		}
	}
};
 ...
 * @private
 */
zz.ui.Ripple.prototype.getFrameCount = function( ){
 ...
 * @param {number} fc
 */
zz.ui.Ripple.prototype.setFrameCount = function( fc ){
 ...
 * @param  {number} newY
 */
zz.ui.Ripple.prototype.setRippleXY = function( newX, newY ){
