 ...
 * Provide section                                                                                                    *
 **********************************************************************************************************************/
goog.provide( 'zz.ui.mdl.DemoAnimation' );
...
DemoAnimation.prototype.CssClasses_ = {
  MOVABLE: goog.getCssName( 'demo-animation__movable' ),
  POSITION_PREFIX: goog.getCssName( 'demo-animation--position-' ),
  FAST_OUT_SLOW_IN: goog.getCssName( 'mdl-animation--fast-out-slow-in' ),
  LINEAR_OUT_SLOW_IN: goog.getCssName( 'mdl-animation--linear-out-slow-in' ),
  FAST_OUT_LINEAR_IN: goog.getCssName( 'mdl-animation--fast-out-linear-in' )
};
...
componentHandler.register({
  ...
  cssClass: goog.getCssName( 'demo-js-animation' )
});

/**********************************************************************************************************************
 * Definition section                                                                                                 *
 **********************************************************************************************************************/
zz.ui.mdl.DemoAnimation = DemoAnimation;